...
import static poker.domain.HandValue.FLUSH;
import static poker.domain.HandValue.FOUR_OF_A_KIND;
import static poker.domain.HandValue.FULL_HOUSE;
import static poker.domain.HandValue.HIGHEST_CARD;
import static poker.domain.HandValue.ONE_PAIR;
import static poker.domain.HandValue.STRAIGHT;
import static poker.domain.HandValue.STRAIGHT_FLUSH;
import static poker.domain.HandValue.THREE_OF_A_KIND;
import static poker.domain.HandValue.TWO_PAIRS;
